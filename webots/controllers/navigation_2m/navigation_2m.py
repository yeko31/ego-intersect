...
def save_camera_image(camera, folder, counter):
    ...
    if image:
        ...
        filename = os.path.join(folder, f"_{counter:06d}.jpg")
...
if __name__ == '__main__':
    ...
    # ================== WAYPOINT NAVIGATION ==================
    waypoints = [
        (-3.16,-3.54,FLYING_ATTITUDE),#0
        (0.892, -3.39, FLYING_ATTITUDE),
        (5.74, -3.39, FLYING_ATTITUDE),
        (5.82, -1.05, FLYING_ATTITUDE),
        (0.967, -1.08, FLYING_ATTITUDE),
        (-4.23, -0.795, FLYING_ATTITUDE),
        (-4.18, 1.27, FLYING_ATTITUDE),#6
        (0.887,1.35, FLYING_ATTITUDE),
        (5.78 ,1.52, FLYING_ATTITUDE),
        (5.84 ,3.7, FLYING_ATTITUDE),
        (0.964 ,3.65, FLYING_ATTITUDE), #done 1st
        (-2.5 ,3.86, FLYING_ATTITUDE),
        (0.964 ,3.65, FLYING_ATTITUDE),
        (5.84 ,3.7, FLYING_ATTITUDE),
        (5.78 ,1.52, FLYING_ATTITUDE),
        (0.887,1.35, FLYING_ATTITUDE),
        (-4.18, 1.27, FLYING_ATTITUDE),#6
    ...
    # Rotation config
    yaw_rotation_points = {
        2: {'direction': +1, 'cycles': 76},   # (5.91, -2.2)
        3: {'direction': +1, 'cycles': 76},   # (5.94, -0.19)
        5: {'direction': -1, 'cycles': 76},
        6: {'direction': -1, 'cycles': 76},
        8: {'direction': +1, 'cycles': 76},
        9: {'direction': +1, 'cycles': 76},
        11: {'direction': +1, 'cycles': 160},
        13: {'direction': -1, 'cycles': 76},
        14: {'direction': -1, 'cycles': 76},
        16:{'direction': +1, 'cycles': 76},
        17:{'direction': +1, 'cycles': 76},
        19: {'direction': -1, 'cycles': 76},
        20: {'direction': -1, 'cycles': 76},
            ...
            # Case 2: INSIDE save_distance_before_wp → trigger wiggle
                ...
                if current_wp_index in straight_buffer and len(straight_buffer[current_wp_index]) > 0:
                    ...
                    for cnt, img_bgr in last_five:
                        filename = os.path.join(STRAIGHT_DIR, f"a200_{cnt:06d}.jpg")
                        cv2.imwrite(filename, img_bgr)
